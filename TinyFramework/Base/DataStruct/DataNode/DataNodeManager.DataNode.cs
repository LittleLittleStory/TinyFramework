...
namespace TinyFramework.DataNode
{
    internal sealed partial class DataNodeManager : TinyFrameworkModule, IDataNodeManager
    {
        /// <summary>
        /// 数据结点。
        /// </summary>
        private sealed class DataNode : IDataNode, IReference
        {
            ...
            public static DataNode Create(string name, DataNode parent)
            {
                if (!IsValidName(name))
                {
                    throw new TinyFrameworkException("Name of data node is invalid.");
                }
            ...
            public bool HasChild(string name)
            {
                if (!IsValidName(name))
                {
                    throw new TinyFrameworkException("Name is invalid.");
                }
