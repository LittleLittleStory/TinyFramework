...
namespace TinyFramework
{
    ...
    public struct TinyFrameworkLinkedListRange<T> : IEnumerable<T>, IEnumerable
    {
        ...
        public TinyFrameworkLinkedListRange(LinkedListNode<T> first, LinkedListNode<T> terminal)
        {
            if (first == null || terminal == null || first == terminal)
            {
                throw new TinyFrameworkException("Range is invalid.");
            }
        ...
        {
            private readonly TinyFrameworkLinkedListRange<T> m_TinyFrameworkLinkedListRange;
            private LinkedListNode<T> m_Current;
            private T m_CurrentValue;

            internal Enumerator(TinyFrameworkLinkedListRange<T> range)
            {
                if (!range.IsValid)
                {
                    throw new TinyFrameworkException("Range is invalid.");
                ...
                m_TinyFrameworkLinkedListRange = range;
                m_Current = m_TinyFrameworkLinkedListRange.m_First;
            ...
            {
                if (m_Current == null || m_Current == m_TinyFrameworkLinkedListRange.m_Terminal)
                {
                    return false;
                }
