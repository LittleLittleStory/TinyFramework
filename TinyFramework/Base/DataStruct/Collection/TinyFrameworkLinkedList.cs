...
namespace TinyFramework
{
    ...
    public sealed class TinyFrameworkLinkedList<T> : ICollection<T>, IEnumerable<T>, ICollection, IEnumerable
    {
        //链表
        ...
        /// 初始化游戏框架链表类的新实例。
        /// </summary>
        public TinyFrameworkLinkedList()
        {
        ...
        public void RemoveFirst()
        {
            ...
            if (first == null)
            {
                throw new TinyFrameworkException("First is invalid.");
            }
        ...
        public void RemoveLast()
        {
            ...
            if (last == null)
            {
                throw new TinyFrameworkException("Last is invalid.");
            }
        ...
        public struct Enumerator : IEnumerator<T>, IEnumerator
        {
            ...
            internal Enumerator(LinkedList<T> linkedList)
            {
                if (linkedList == null)
                {
                    throw new TinyFrameworkException("Linked list is invalid.");
                }
