...
namespace TinyFramework
{
    ...
    internal sealed class TaskPool<T> where T : TaskBase
    {
        ...
        private readonly TinyFrameworkLinkedList<ITaskAgent<T>> m_WorkingAgents;
        private readonly TinyFrameworkLinkedList<T> m_WaitingTasks;
        ...
        public TaskPool()
        {
            ...
            m_WorkingAgents = new TinyFrameworkLinkedList<ITaskAgent<T>>();
            m_WaitingTasks = new TinyFrameworkLinkedList<T>();
            m_Paused = false;
        }
