...
namespace TinyFramework.DataTable
{
    ...
    public interface IDataTableHelper
    {
        ...
        IEnumerable<TinyFrameworkSegment<string>> GetDataRowSegments(string text);
        ...
        /// <returns>数据表行片段。</returns>
        IEnumerable<TinyFrameworkSegment<byte[]>> GetDataRowSegments(byte[] bytes);
        ...
        /// <returns>数据表行片段。</returns>
        IEnumerable<TinyFrameworkSegment<Stream>> GetDataRowSegments(Stream stream);
