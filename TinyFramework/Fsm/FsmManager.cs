...
namespace TinyFramework.Fsm
{
    ...
    internal sealed class FsmManager : TinyFrameworkModule, IFsmManager
    {
        ...
        public bool HasFsm(Type ownerType)
        {
            if (ownerType == null)
            {
                throw new TinyFrameworkException("Owner type is invalid.");
            }
        ...
        public IFsm<T> CreateFsm<T>(string name, T owner, params FsmState<T>[] states) where T : class
        {
            ...
            if (HasFsm<T>(name))
            {
                throw new TinyFrameworkException(Utility.Text.Format("Already exist FSM '{0}'.", typeNamePair.ToString()));
            }
        ...
        public IFsm<T> CreateFsm<T>(string name, T owner, List<FsmState<T>> states) where T : class
        {
            ...
            if (HasFsm<T>(name))
            {
                throw new TinyFrameworkException(Utility.Text.Format("Already exist FSM '{0}'.", typeNamePair));
            }
        ...
        public bool DestroyFsm<T>(IFsm<T> fsm) where T : class
        {
            if (fsm == null)
            {
                throw new TinyFrameworkException("FSM is invalid.");
            }
