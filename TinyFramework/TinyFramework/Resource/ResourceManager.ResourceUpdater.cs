...
namespace TinyFramework.Resource
{
    internal sealed partial class ResourceManager : TinyFrameworkModule, IResourceManager
    {
        ...
        private sealed partial class ResourceUpdater
        {
            ...
            public TinyFrameworkAction<ResourceName, string, string, int, int, int> ResourceUpdateStart;
            public TinyFrameworkAction<ResourceName, string, string, int, int> ResourceUpdateChanged;
            public TinyFrameworkAction<ResourceName, string, string, int, int> ResourceUpdateSuccess;
            public TinyFrameworkAction<ResourceName, string, int, int, string> ResourceUpdateFailure;
            public TinyFrameworkAction<ResourceGroup, bool, bool> ResourceUpdateAllComplete;
            ...
            public void UpdateResources(ResourceGroup resourceGroup)
            {
                ...
                if (m_UpdatingResourceGroup != null)
                {
                    throw new Exception(Utility.Text.Format("There is already a resource group '{0}' being updated.", m_UpdatingResourceGroup.Name));
                }
            ...
            private void GenerateReadWriteList()
            {
                ...
                catch (Exception exception)
                {
                    ...
                    throw new Exception(Utility.Text.Format("Pack save exception '{0}'.", exception.ToString()), exception);
                }
                finally
                {
                    if (fileStream != null)
            ...
            private void OnDownloadSuccess(object sender, DownloadSuccessEventArgs e)
            {
                ...
                {
                    throw new Exception(Utility.Text.Format("Resource info '{0}' is already exist.", updateInfo.ResourceName.FullName));
                }
                ...
                {
                    throw new Exception(Utility.Text.Format("Read-write resource info '{0}' is already exist.", updateInfo.ResourceName.FullName));
                }
