            ...
            private sealed class AssetObject : ObjectBase
            {
                ...
                protected internal override void Release(bool isShutdown)
                {
                    if (!isShutdown)
                    {
                        ...
                        {
                            throw new Exception(Utility.Text.Format("Asset target '{0}' reference count is '{1}' larger than 0.", Name, targetReferenceCount.ToString()));
                        }
                        ...
                        foreach (object dependencyAsset in m_DependencyAssets)
                        {
                            ...
                            {
                                throw new Exception(Utility.Text.Format("Asset target '{0}' dependency asset reference count is invalid.", Name));
                            }
                        }
