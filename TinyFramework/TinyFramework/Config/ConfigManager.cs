...
namespace TinyFramework.Config
{
    ...
    internal sealed partial class ConfigManager : GameFrameworkModule//, IConfigManager
    {
        ...
        public void LoadConfig(string configAssetName, LoadType loadType, int priority, object userData)
        {
            ...
            {
                throw new Exception("You must set config helper first.");
            }
        ...
        public bool ParseConfig(string text, object userData)
        {
            ...
            {
                throw new Exception(String.Format("Can not parse config with exception '{0}'.", exception.ToString()), exception);
            }
        }
        ...
        public bool GetBool(string configName)
        {
            ...
            {
                throw new Exception(String.Format("Config name '{0}' is not exist.", configName));
            }
        ...
        private void LoadConfigSuccessCallback(string configAssetName, object configAsset, float duration, object userData)
        {
            ...
            {
                throw new Exception("Load config info is invalid.");
            }
            ...
            try
            {
                ...
                {
                    throw new Exception(String.Format("Load config failure in helper, asset name '{0}'.", configAssetName));
                }
