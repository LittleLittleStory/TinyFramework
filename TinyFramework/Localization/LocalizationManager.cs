...
namespace TinyFramework.Localization
{
    ...
    internal sealed partial class LocalizationManager : TinyFrameworkModule, ILocalizationManager
    {
        ...
        public LocalizationManager()
        {
            ...
            m_LoadAssetCallbacks = new LoadAssetCallbacks(LoadDictionarySuccessCallback, LoadDictionaryFailureCallback, LoadDictionaryDependencyAssetCallback);
        ...
        public Language Language
        {
            ...
            set
            {
                ...
                {
                    throw new TinyFrameworkException("Language is invalid.");
                }
        ...
        public Language SystemLanguage
        {
            get
            {
                ...
                {
                    throw new TinyFrameworkException("You must set localization helper first.");
                }
        ...
        public void SetLocalizationHelper(ILocalizationHelper localizationHelper)
        {
            ...
            {
                throw new TinyFrameworkException("Localization helper is invalid.");
            }
        ...
        public bool ParseDictionary(string text, object userData)
        {
            ...
            catch (TinyFrameworkException TinyFrameworkException)
            {
                if (TinyFrameworkException is TinyFrameworkException)
                {
                    throw;
                }

                throw new TinyFrameworkException(Utility.Text.Format("Can not parse dictionary with TinyFrameworkException '{0}'.", TinyFrameworkException.ToString()), TinyFrameworkException);
            }
        }
        ...
        public string GetString(string key)
        {
            ...
            {
                throw new TinyFrameworkException("Key is invalid.");
            }
        ...
        public string GetString(string key, object arg0)
        {
            ...
            {
                return Utility.Text.Format("<Error>{0},{1},{2},{3}", key, value, arg0, TinyFrameworkException.ToString());
            }
        }
        ...
        public string GetString(string key, object arg0, object arg1)
        {
            ...
            {
                return Utility.Text.Format("<Error>{0},{1},{2},{3},{4}", key, value, arg0, arg1, TinyFrameworkException.ToString());
            }
        }
        ...
        public string GetString(string key, object arg0, object arg1, object arg2)
        {
            ...
            {
                return Utility.Text.Format("<Error>{0},{1},{2},{3},{4},{5}", key, value, arg0, arg1, arg2, TinyFrameworkException.ToString());
            }
        }
        ...
        public string GetString(string key, params object[] args)
        {
            ...
            catch (TinyFrameworkException TinyFrameworkException)
            {
                ...
                errorString += "," + TinyFrameworkException.ToString();
                return errorString;
            }
        }
        ...
        private void LoadDictionarySuccessCallback(string dictionaryAssetName, object dictionaryAsset, float duration, object userData)
        {
            ...
            {
                throw new TinyFrameworkException("Load dictionary info is invalid.");
            }
            ...
            try
            {
                ...
                {
                    throw new TinyFrameworkException(Utility.Text.Format("Load dictionary failure in helper, asset name '{0}'.", dictionaryAssetName));
                }
            ...
            catch (TinyFrameworkException TinyFrameworkException)
            {
                ...
                {
                    LoadDictionaryFailureEventArgs loadDictionaryFailureEventArgs = LoadDictionaryFailureEventArgs.Create(dictionaryAssetName, loadDictionaryInfo.LoadType, TinyFrameworkException.ToString(), loadDictionaryInfo.UserData);
