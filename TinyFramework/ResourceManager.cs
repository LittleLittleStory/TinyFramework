    ...
    internal sealed partial class ResourceManager : TinyFrameworkModule, IResourceManager
    {
        ...
        public int GenerateReadWriteListLength
        {
            ...
            set
            {
                ...
                {
                    throw new TinyFrameworkException("You can not use GenerateReadWriteListLength at this time.");
                }
        ...
        public int UpdateRetryCount
        {
            ...
            set
            {
                if (m_ResourceUpdater == null)
                {
                    throw new TinyFrameworkException("You can not use UpdateRetryCount at this time.");
                }
        ...
        public void SetReadOnlyPath(string readOnlyPath)
        {
            ...
            {
                throw new TinyFrameworkException("Readonly path is invalid.");
            }

            if (m_ResourceLoader.TotalAgentCount > 0)
            {
                throw new TinyFrameworkException("You must set readonly path before add load resource agent helper.");
            }
        ...
        public void SetReadWritePath(string readWritePath)
        {
            ...
            {
                throw new TinyFrameworkException("Read-write path is invalid.");
            }

            if (m_ResourceLoader.TotalAgentCount > 0)
            {
                throw new TinyFrameworkException("You must set read-write path before add load resource agent helper.");
            }
        ...
        public void SetResourceMode(ResourceMode resourceMode)
        {
            ...
            {
                throw new TinyFrameworkException("Resource mode is invalid.");
            }
            ...
            {
                throw new TinyFrameworkException("You can not change resource mode at this time.");
            }
        }
        ...
        public void SetCurrentVariant(string currentVariant)
        {
            ...
            {
                throw new TinyFrameworkException("You can net set current variant at this time.");
            }
        ...
        public void SetObjectPoolManager(IObjectPoolManager objectPoolManager)
        {
            ...
            {
                throw new TinyFrameworkException("Object pool manager is invalid.");
            }
        ...
        public void SetDownloadManager(IDownloadManager downloadManager)
        {
            ...
            {
                throw new TinyFrameworkException("Download manager is invalid.");
            }
        ...
        public void SetDecryptResourceCallback(DecryptResourceCallback decryptResourceCallback)
        {
            if (m_ResourceLoader.TotalAgentCount > 0)
            {
                throw new TinyFrameworkException("You must set decrypt resource callback before add load resource agent helper.");
            }
        ...
        public void SetResourceHelper(IResourceHelper resourceHelper)
        {
            ...
            {
                throw new TinyFrameworkException("Resource helper is invalid.");
            }

            if (m_ResourceLoader.TotalAgentCount > 0)
            {
                throw new TinyFrameworkException("You must set resource helper before add load resource agent helper.");
            }
        ...
        public void InitResources(InitResourcesCompleteCallback initResourcesCompleteCallback)
        {
            ...
            {
                throw new TinyFrameworkException("Init resources complete callback is invalid.");
            }

            if (m_ResourceMode == ResourceMode.Unspecified)
            {
                throw new TinyFrameworkException("You must set resource mode first.");
            }

            if (m_ResourceMode != ResourceMode.Package)
            {
                throw new TinyFrameworkException("You can not use InitResources without package resource mode.");
            }

            if (m_ResourceIniter == null)
            {
                throw new TinyFrameworkException("You can not use InitResources at this time.");
            }
        ...
        public CheckVersionListResult CheckVersionList(int latestInternalResourceVersion)
        {
            ...
            {
                throw new TinyFrameworkException("You can not use CheckVersionList without updatable resource mode.");
            }

            if (m_VersionListProcessor == null)
            {
                throw new TinyFrameworkException("You can not use CheckVersionList at this time.");
            }
        ...
        public void UpdateVersionList(int versionListLength, int versionListHashCode, int versionListZipLength, int versionListZipHashCode, UpdateVersionListCallbacks updateVersionListCallbacks)
        {
            ...
            {
                throw new TinyFrameworkException("Update version list callbacks is invalid.");
            }
            ...
            if (m_ResourceMode != ResourceMode.Updatable)
            {
                throw new TinyFrameworkException("You can not use UpdateVersionList without updatable resource mode.");
            }

            if (m_VersionListProcessor == null)
            {
                throw new TinyFrameworkException("You can not use UpdateVersionList at this time.");
            }
        ...
        public void CheckResources(CheckResourcesCompleteCallback checkResourcesCompleteCallback)
        {
            ...
            {
                throw new TinyFrameworkException("Check resources complete callback is invalid.");
            }
            ...
            if (m_ResourceMode != ResourceMode.Updatable)
            {
                throw new TinyFrameworkException("You can not use CheckResources without updatable resource mode.");
            }

            if (m_ResourceChecker == null)
            {
                throw new TinyFrameworkException("You can not use CheckResources at this time.");
            }
        ...
        public void UpdateResources(string resourceGroupName, UpdateResourcesCompleteCallback updateResourcesCompleteCallback)
        {
            ...
            {
                throw new TinyFrameworkException("Update resources complete callback is invalid.");
            }
            ...
            if (m_ResourceMode != ResourceMode.Updatable)
            {
                throw new TinyFrameworkException("You can not use UpdateResources without updatable resource mode.");
            }

            if (m_ResourceUpdater == null)
            {
                throw new TinyFrameworkException("You can not use UpdateResources at this time.");
            }

            ResourceGroup resourceGroup = (ResourceGroup)GetResourceGroup(resourceGroupName);
            if (resourceGroup == null)
            {
                throw new TinyFrameworkException(Utility.Text.Format("Can not find resource group '{0}'.", resourceGroupName));
            }
        ...
        public bool HasAsset(string assetName)
        {
            ...
            {
                throw new TinyFrameworkException("Asset name is invalid.");
            }
        ...
        public void LoadAsset(string assetName, LoadAssetCallbacks loadAssetCallbacks)
        {
            ...
            {
                throw new TinyFrameworkException("Load asset callbacks is invalid.");
            }
        ...
        public void UnloadAsset(object asset)
        {
            if (asset == null)
            {
                throw new TinyFrameworkException("Asset is invalid.");
            }
        ...
        public void LoadScene(string sceneAssetName, LoadSceneCallbacks loadSceneCallbacks)
        {
            ...
            {
                throw new TinyFrameworkException("Scene asset name is invalid.");
            }

            if (loadSceneCallbacks == null)
            {
                throw new TinyFrameworkException("Load scene callbacks is invalid.");
            }
        ...
        public void UnloadScene(string sceneAssetName, UnloadSceneCallbacks unloadSceneCallbacks)
        {
            ...
            {
                throw new TinyFrameworkException("Unload scene callbacks is invalid.");
            }
