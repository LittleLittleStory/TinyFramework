...
namespace TinyFramework.Download
{
    internal sealed partial class DownloadManager : TinyFrameworkModule, IDownloadManager
    {
        ...
        private sealed class DownloadAgent : ITaskAgent<DownloadTask>, IDisposable
        {
            ...
            public Action<DownloadAgent, int> DownloadAgentSuccess;
            ...
            public DownloadAgent(IDownloadAgentHelper downloadAgentHelper)
            {
                ...
                {
                    throw new TinyFrameworkException("Download agent helper is invalid.");
                }
            ...
            public StartTaskStatus Start(DownloadTask task)
            {
                if (task == null)
                {
                    throw new TinyFrameworkException("Task is invalid.");
                }
            ...
            private void OnDownloadAgentHelperComplete(object sender, DownloadAgentHelperCompleteEventArgs e)
            {
                ...
                {
                    throw new TinyFrameworkException("Internal download error.");
                }
