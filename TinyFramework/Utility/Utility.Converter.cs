    ...
    public static partial class Utility
    {
        ...
        public static class Converter
        {
            ...
            public static float GetCentimetersFromPixels(float pixels)
            {
                if (ScreenDpi <= 0)
                {
                    throw new TinyFrameworkException("You must set screen DPI first.");
                }
            ...
            public static void GetBytes(bool value, byte[] buffer, int startIndex)
            {
                if (buffer == null)
                {
                    throw new TinyFrameworkException("Buffer is invalid.");
                }

                if (startIndex < 0 || startIndex + 1 > buffer.Length)
                {
                    throw new TinyFrameworkException("Start index is invalid.");
                }
            ...
            public static string GetString(byte[] value)
            {
                if (value == null)
                {
                    throw new TinyFrameworkException("Value is invalid.");
                }
